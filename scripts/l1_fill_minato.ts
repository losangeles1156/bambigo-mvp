...
// --- Main (Minato Fill) ---
async function main() {
    console.log('=== L1 Minato Fill (Specific Targets) ===');
    ...
    if (!stations || stations.length === 0) return console.error('No stations found matching IDs');

    console.log(`Found ${stations.length} / ${TARGET_IDS.length} target stations.`);
