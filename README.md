...
> **BambiGO 是一個「AI 移動導引助手」——在你於日本旅行「卡住的時刻(不知道如何選擇)」，主動告訴你下一步應該怎麼做。**
...
小鹿初次踏入森林，對環境不熟悉、充滿不確定——就像旅客第一次面對複雜的東京交通。BambiGO 想做的，是成為那個「在旁邊輕聲提醒你該怎麼走」的存在。
...
> **一句話總結**：現有工具是「被動的百科全書」，BambiGO 是「主動的在地嚮導」。
...
BambiGO 的建議不是憑空生成，而是結合三種資料：
**結構化資料 × 經驗規則 × 即時狀態**

| 資料類型 | 來源 | 用途 |
| :--- | :--- | :--- |
| **結構化資料** | ODPT 開放數據（時刻表、路線、車站設施） | 基礎路線規劃 |
| **經驗規則** | 人工標註的「搭乘陷阱」知識庫 | 心理建設、預警提醒 |
| **即時狀態** | GTFS-RT 運行資訊、異常通知 | 動態調整建議 |

這就是 BambiGO 和純 AI 聊天機器人的差別——不是只靠 LLM 回答，而是有真實數據支撐。
...
*   **BambiGO**: ⚠️ 「京葉線月台距離其他路線約 500 公尺，需走一條長地下通道，建議預留 15-20 分鐘。拖行李會很累，考慮先寄放在置物櫃？」
    *   💡 **差異**：Google Maps 只給數字，BambiGO 給你心理準備 + 可執行建議

### 案例 2：上野站搭新幹線
*情境：你要搭 10:00 從上野發車的新幹線*
*   **傳統做法**: 你自己估時間，9:55 到入口
*   **BambiGO**: ⚠️ 「新幹線月台在地下四層，進站後到月台還需 10-15 分鐘。建議 9:40 前抵達上野站入口。」
    *   💡 **差異**：不是到現場才發現來不及，而是事前就提醒注意事項

### 案例 3：異常發生時的主動提醒
*情境：你訂閱了每天通勤的路線，今天銀座線有異常*
*   **傳統做法**: 到月台才發現電車沒來，查詢才知道延誤。
*   **BambiGO**: 收到 ODPT 異常延誤數據主動推播：「銀座線目前有延誤，預計影響 20 分鐘。建議改搭丸之內線，路線已幫你查好 👉 [一鍵查看]」
